...
where rea_nom = 'Castillo' and rea_prenom = 'Geraldine';
...
select *
from Utilisateurs
join Roles on Utilisateurs.rol_id = Roles.rol_id
...
where uti_pseudo = 'Noel' and art_titre = 'Phasellus vitae mauris sit';


--9--

--afficher tous les films mis en scène par un réalisateur
--dont les acteurs sont nés en 1960
...
join Realisateur on mes_rea_id = rea_id
where rea_sex = 'Yes' 
and act_date_naissance between '01/01/1960' and '31/12/1960'
